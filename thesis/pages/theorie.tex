...
Einfache- als auch Multigraphen abdecken kann, ist es aber warhscheinlich, dass
...
damit zusammen, dass Gephi sich nur mit der graphische Oberfläche gestartet werden
kann.

\subsection{Connectoren}
Connectoren sind der entscheidene Punkt, wenn es darum geht verschieden Systeme
mit einander zu verbinden. Dies ist gerade beim Streaming entscheidend, da die
Daten ja in Echtzeit von verschiedenen Systemen gelesen und wieder geschrieben
werden sollen.

Apache Flink unterstützt ebenfalls Connectoren. Dabei werden einige Connectoren
...
System eine Client-Bibliothek existiert, dann lässt sich ein Connector mit
